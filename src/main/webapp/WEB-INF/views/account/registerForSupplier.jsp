...
<div class="container">
	<div class=dang-nhap>
		<h2>Đăng ký trở thành Người bán trên LambdaBuy</h2>
		<h4 class="label label-success">${message}</h4>
		<form:form action="/supplier/register" modelAttribute="form"
			...
			<a class="btn btn-default" href="/supplier/register"><s:message code="act.button.reset" /></a>
		</form:form>
	</div>
</div>
<br/>
