...
<div class="row">
	...
	<div class="col-lg-12">
			<h3>Tồn kho theo loại sản phẩm</h3>
		</div>
	<!-- /.col-lg-12 -->
</div>
...
<script>
	function changeText(){
		$('#mySelect').change(function(){
			...
			document.getElementById("thongke").href="productBySupplier/"+id; 
	...
	function changeTextBrand(){
		$('#mySelectBrand').change(function(){
			...
			document.getElementById("thongkeBrand").href="productByBrand/"+id; 
			//btn.textContent =  name;
		})
	}
	...
	function changeTextCategory(){
		$('#mySelectCategory').change(function(){
			...
			document.getElementById("thongkeCategory").href="productByCategory/"+id; 
			//btn.textContent =  name;
		})
	}
</script>
